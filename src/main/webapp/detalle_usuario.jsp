        ...
        <div class="container" style="max-width: 900px;">
            <div style="display: flex; flex-wrap: wrap; gap: 40px; align-items: center;">
                ...
                <div style="flex: 1; min-width: 250px; text-align: center;">
                    ...
                    <p style="margin-top: 15px; font-weight: bold; color: #666;">ID de Usuario: #<%= uDetalle.getId_usuario() %></p>
                </div>
                ...
                <div style="flex: 1.5; min-width: 300px;">
                    ...
                    <div class="table-container" style="margin: 0;">
                        <table style="font-size: 0.95em;">
                            <tbody>
                                ...
                                <tr><td><strong>Username</strong></td><td><%= uDetalle.getUsuario() %></td></tr>
                                <tr><td><strong>Nombre</strong></td><td><%= uDetalle.getNombre() != null ? uDetalle.getNombre() : "---" %></td></tr>
                                <tr><td><strong>Apellidos</strong></td><td><%= uDetalle.getApellidos() != null ? uDetalle.getApellidos() : "---" %></td></tr>
                                <tr><td><strong>Email</strong></td><td><%= uDetalle.getEmail() %></td></tr>
                                <tr><td><strong>Teléfono</strong></td><td><%= uDetalle.getTelefono() != null ? uDetalle.getTelefono() : "No registrado" %></td></tr>
                                <tr><td><strong>Dirección</strong></td><td><%= uDetalle.getDireccion() != null ? uDetalle.getDireccion() : "No registrada" %></td></tr>
                                <tr><td><strong>Rol</strong></td><td><span class="badge"><%= uDetalle.getRol() %></span></td></tr>
                                <tr><td><strong>Nivel</strong></td><td><%= uDetalle.getRol().getNivel() %></td></tr>
                    ...
                    <div class="form-buttons" style="justify-content: flex-start; margin-top: 25px;">    
                        ...
                        <% if (miUsuario.getRol().getNivel() == 1 && uDetalle.getId_usuario() != miUsuario.getId_usuario()) { %>
						    <a href="EliminarUsuario?id=<%= uDetalle.getId_usuario() %>" 
