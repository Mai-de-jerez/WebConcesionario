...
<body>
    <div class="container">
        ...
        <div class="welcome-section">
	        <p>Estás gestionando el sistema como: <strong><%= usu.getRol().name() %></strong></p>
        </div>
        ...
        <div class="feature-cards">
            ...
            <div class="feature-card" onclick="location.href='ListarPedidos?origen=admin'" style="cursor: pointer;">
