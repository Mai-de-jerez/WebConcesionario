            ...
            <table id="tablaPedidos">
                ...
                <tbody>
                    ...
                    <tr>
						...
						<td style="font-size: 0.9em; color: #555;"><%= p.getNombreUsuario() %></td>
					    
					    <td><%= (p.getFecha() != null) ? sdf.format(p.getFecha()) : "---" %></td>
	
                        <td style="font-weight: bold;"><%= String.format("%.2f", p.getTotal()) %> €</td>
                        <td>
